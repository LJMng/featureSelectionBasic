...
/**
 * An interface for implementations involve <strong>Compacted Decision Table</strong>
 * Attribute Reduction, bases on the paper
 ...
 * @author Benjamin_L
 */
public interface CompactedDesicionTableStrategy extends AlgStrategy {}