package featureSelection.basic.procedure.parameter;
...
/**
 * Procedure parameters manager. Using a {@link Map} to save parameters and {@link Set}
 * to store <strong>ROOT</strong> parameter keys/names.
 * <p>
 * Parameters can be set to <strong>ROOT</strong> for re-use. For <strong>non-ROOT
 * </strong> parameters, they can be deleted by calling {@link #deleteNonRoots()}
 * while <strong>ROOT</strong> parameters stay.
 * 
 * @author Benjamin_L
 */
public class ProcedureParameters {
	 ...
	 * @return <code>this</code> instance.
	 */
	public <T> ProcedureParameters setNonRoot(String key, T value) {
