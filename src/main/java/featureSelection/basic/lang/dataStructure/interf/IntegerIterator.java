package featureSelection.basic.lang.dataStructure.interf;

/**
 * Iterator for Integer values.
 * <p>
 * <strong>PS</strong>: The most secure way to execute the iterator is to
 * <code>reset()</code> before an iteration.
 *
 * @author Benjamin_L
 */
public interface IntegerIterator extends Cloneable, Iterable<Integer> {
